...
COLUMN_METADATA = {
    ...
    "imbalance_total_revenue": {"unit": CURRENCY_UNIT, "aggregation": "sum", "label": "Imbalance settlement cash flow"},
    "imbalance_long_revenue": {"unit": CURRENCY_UNIT, "aggregation": "sum", "label": "Long imbalance settlement cash flow"},
    "imbalance_short_revenue": {"unit": CURRENCY_UNIT, "aggregation": "sum", "label": "Short imbalance settlement cash flow"},
    ...
    "revenue_vs_epex_calc": {"unit": CURRENCY_UNIT, "aggregation": "sum", "label": "Imbalance settlement cash flow"},
    "delivered_day_ahead_value_calc": {"unit": CURRENCY_UNIT, "aggregation": "sum", "label": "Delivered volume at day-ahead value"},
    "imbalance_gain_loss_vs_day_ahead_calc": {"unit": CURRENCY_UNIT, "aggregation": "sum", "label": "Imbalance gain/loss vs day-ahead"},
...
ANOMALY_SPECS = {
    "negative-imbalance-revenue": {
        "label": "Large negative imbalance settlement cash flow",
        "metric": "imbalance_total_revenue",
        "largest": False,
        "file_name": "anomaly_negative_imbalance_revenue.csv",
        "description": "Periods with the largest negative imbalance settlement cash flow.",
    },
    "positive-imbalance-revenue": {
        "label": "Large positive imbalance settlement cash flow",
        "metric": "imbalance_total_revenue",
        "largest": True,
        "file_name": "anomaly_positive_imbalance_revenue.csv",
        "description": "Periods with the largest positive imbalance settlement cash flow.",
    },
